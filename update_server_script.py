...
pw = PASSWORD
spw = SUDOPASSWORD
def update_server(ip, username, pw, spw, remove_directories_from_server = False, update_directories_on_server = True):
    Remove_directories = remove_directories_from_server
    Update_directories = update_directories_on_server
...
if __name__ == "__main__":
    ...
    update_server(ip, username, pw, spw, remove_directories_from_server = False,
     update_directories_on_server = True)
